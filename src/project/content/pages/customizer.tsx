...
const Customizer = observer( () => {
  ...
  return (
    <>
      ...
      <Col size={3} mr="15px">
          <H6 textTransform='uppercase'>bg Primary</H6>
      ...
      <Col size={3} mr="15px">
          <H6 textTransform='uppercase'>bg Secondary</H6>
          <Box mt="10px" display="flex" alignitems="center">
            <Input type="color" value={customTheme.bgSecondary} p="0" border="none" mb="0" h="50px" w='50px'  
