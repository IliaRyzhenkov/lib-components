    ...
    <>
      ...
      <Row mb="20px" justifycontent='flex-start' alignitems="center">
        ...
        <Box bg="#FBDDFF" p="14px 20px" color="#655DBB">
          <P ls="0.4px" lh='1.4' fw="500">hover='reverseBorder' bg="black" textTransform="uppercase" ls="1px" p="20px" fs="18px" minW="300px"</P>
        </Box>
      </Row>
      <Row mb="20px" justifycontent='flex-start' alignitems="center">
        <Button mr="20px" hover='reverseBorder' bg="orange" textTransform="uppercase" ls="1px" minW="200px" shadow='variant-1'>Custom-2</Button>
        <Box bg="#FBDDFF" p="14px 20px" color="#655DBB">
          <P ls="0.4px" lh='1.4' fw="500">hover='reverseBorder' bg="orange" textTransform="uppercase" ls="1px" minW="200px" shadow='variant-1'</P>
        </Box>
      </Row>
      <Row mb="20px" justifycontent='flex-start' alignitems="center">
        <Button mr="20px" bg="#02AAD6" hoverbg="#3DD4C3" textTransform="uppercase" ls="1px" minW="200px" shadow='variant-2' shadowcolor="#02AAD6">Custom-3</Button>
        <Box bg="#FBDDFF" p="14px 20px" color="#655DBB">
          <P ls="0.4px" lh='1.4' fw="500">bg="#02AAD6" hoverbg="#3DD4C3" textTransform="uppercase" ls="1px" minW="200px" shadow='variant-2' shadowcolor="#02AAD6"</P>
        </Box>
      </Row>
